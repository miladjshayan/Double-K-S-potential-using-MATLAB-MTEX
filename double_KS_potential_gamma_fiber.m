%% Double K-S Potential Along the Gamma-Fiber
...
% Step size along the gamma-fiber
fiberStep = 1;
...
%% ========================================================================
% Define the gamma-fiber
% {111} || ND
% ==========================================================================

phi1_list = (0:fiberStep:90)';
...
fprintf('Calculating double K-S potential along the gamma-fiber...\n');
...
summaryFile = fullfile( ...
    outFolder, ...
    'GammaFiber_DoubleKS_Potential.csv');
...
fprintf('Reference gamma-fiber phi1 = %.1f deg\n', ...
    BestPhi1);
...
title('Double K-S Potential Along \gamma-Fiber');
